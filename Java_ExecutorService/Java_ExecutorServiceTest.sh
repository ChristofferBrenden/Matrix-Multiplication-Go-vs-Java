...
nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 16 >> /dev/null
...
while [ $COUNTER -lt $MAX ]; do
    ...
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 0 >> result.txt
done
...
while [ $COUNTER -lt $MAX ]; do
    ((COUNTER++))
    echo "Running test #$COUNTER"
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 1 >> result.txt
done
...
while [ $COUNTER -lt $MAX ]; do
    ((COUNTER++))
    echo "Running test #$COUNTER"
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 2 >> result.txt
done
...
while [ $COUNTER -lt $MAX ]; do
    ((COUNTER++))
    echo "Running test #$COUNTER"
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 4 >> result.txt
done
...
while [ $COUNTER -lt $MAX ]; do
    ((COUNTER++))
    echo "Running test #$COUNTER"
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 8 >> result.txt
done
...
while [ $COUNTER -lt $MAX ]; do
    ((COUNTER++))
    echo "Running test #$COUNTER"
    nice -n -20 java -Xms1g -Xmx1g Java_ExecutorService 4096.in 16 >> result.txt
done
